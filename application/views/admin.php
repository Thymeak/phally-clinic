...
<html>
    <head>
        ...
        <!--clock init-->
        <script src="<?php echo base_url() ?>public/js/css3clock.js"></script>
        <!--Easy Pie Chart-->
        <!--skycons-icons-->
        <script src="<?php echo base_url() ?>public/js/skycons.js"></script>

        <script src="<?php echo base_url() ?>public/js/jquery.easydropdown.min.js"></script>
                    ...
                    <div class="header-section">
                        ...
                        <div class="top_menu">
                            <div class="main-search">
                                ...
                                <div class="close"><img src="<?php echo base_url() ?>/public/images/cross.png" /></div>
                            </div>
                                ...
                                <ul class="nofitications-dropdown">
                                    ...
                                    <li class="dropdown note">
                                        ...
                                        <ul class="dropdown-menu two first">
                                            ...
                                            <li><a href="#">
                                                    <div class="user_img"><img src="<?php echo base_url() ?>public/images/1.jpg" alt=""></div>
                ...
                <ul id="menu" >
                    ...
                    <li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i> <span>ផ្នែកជំងឺទូទៅ</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                        <ul id="menu-academico-sub" >
                            <li id="menu-academico-avaliacoes" ><a href="<?php echo base_url() ?>./admin/viewGeneralin">ប័ណ្ណចូលសំរាកពេទ្យ</a></li>
                            <li id="menu-academico-avaliacoes" ><a href="<?php echo base_url() ?>./admin/test_viewcustomer">Test</a></li>
                        </ul>
                    </li>
                    <li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i> <span>ផ្នែកសម្ភព និង រោគស្រ្តី</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                        <ul id="menu-academico-sub" >
                            ...
                            <li id="menu-academico-avaliacoes" ><a href="<?php echo base_url() ?>admin/viewMaternityLetterBirth">លិខិតបញ្ចាក់កំណើត</a></li>
                            <li id="menu-academico-avaliacoes" ><a href="<?php echo base_url() ?>admin/viewPrescription">ចេញវិជ្ជះបញ្ជា</a></li>
                        </ul>
                    </li>
                    <li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i> <span>ផ្នែកមន្ទីរពិសោធន៍</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                        <ul id="menu-academico-sub" >
                    ...
                    <li id="menu-academico-avaliacoes" ><a href="<?php echo base_url() ?>admin/viewLaborPCR">PCR-HBV</a></li>
                        </ul>
                    </li>
    ...
    <!--js -->
    <link rel="stylesheet" href="<?php echo base_url() ?>public/css/vroom.css">
    <script type="text/javascript" src="<?php echo base_url() ?>public/js/vroom.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>public/js/TweenLite.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>public/js/CSSPlugin.min.js"></script>
